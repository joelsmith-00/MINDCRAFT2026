...
def lumi_loop(pause_event, registry, args):
    ...
    if args.text:
        ...
        speak("Hello Joel, I am Lumi. I'm ready.")
    ...
    while True:
        ...
        if "lumi" not in user_query and not is_direct:
            print(f"Ignored: {user_query}")
            continue
            
        clean_query = user_query.replace("lumi", "").strip()
...
def main():
    ...
    # 3. Start LUMI Loop in Background Thread
